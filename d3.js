d3 = function() {
	...
	//var animation = prompt("Please enter a time in seconds for the animation", "10");
	//var interval = prompt("Please enter an interval in seconds between the two animations", "2");
	//var starting = prompt("Please enter a starting number", "1");
	//var type = prompt("Please enter an animation type. Possible values are: Fibonacci, Factorial and Prime. (case-sensitive)", "Fibonacci");
	//while (type != "Fibonacci" && type != "Factorial" && type != "Prime")
	//{
	//	var type = prompt("Your animation type did not match one of the accepted values. Please enter an animation type. Possible values are: Fibonacci, Factorial and Prime. (case-sensitive)", "Fibonacci");
	//}
  var d3 = {
    version: "3.2.8"
  };
